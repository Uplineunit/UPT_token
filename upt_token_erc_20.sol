...
library Address {
    ...
    contract UPLINETOKEN is Context, IERC20, Ownable {
    ...
    address public marketingWallet = //insert your wallet here;
   

    string private constant _name = "UPLINE TOKEN";
    string private constant _symbol = "UPT";
    ...
    constructor(address routerAddress) {
        ...
        _isExcludedFromFee[//insert your wallet here] = true;
        _isExcludedFromFee[//insert your wallet here] = true;  
        ...
        allowedTransfer[//insert your wallet here] = true;
        allowedTransfer[//insert your wallet here] = true;
